...
class Test:
    ...
    def generate_seeds(self, line_spacing: int, column_spacing: int, origin: list):
        ...
        Agent(self.sim, seed_pos[0], swarm_pos=seed_deltas[0] * [1, -1]),
        Agent(self.sim, seed_pos[1], swarm_pos=seed_deltas[1] * [1, -1]),
        Agent(self.sim, seed_pos[2], swarm_pos=seed_deltas[2] * [1, -1]),
        Agent(self.sim, seed_pos[3], swarm_pos=seed_deltas[3] * [1, -1]),
